...
public sealed class ConcertFilter
{
    ...
    /// </para>
    /// <para>
    /// Несмотря на то, что <paramref name="today"/> представляет текущую дату,
    /// значение не генерируется автоматически с помощью <see cref="DateTime.Now"/>.
    /// Это необходимо для того, чтобы синхронизировать <paramref name="today"/> 
    /// с элементами управления на компоненте или странице.</para>
    /// </param>
